...
SFT_MODEL_DIR = "other_experiments/dpo_novagents_llama_mistral/mistral/sft_model"
DPO_MODEL_DIR = "other_experiments/dpo_novagents_llama_mistral/mistral/dpo_model"

# Intermediate directory: base model + SFT weights merged (full model, not adapter)
MERGED_SFT_DIR = "other_experiments/dpo_novagents_llama_mistral/mistral/sft_model_merged"
