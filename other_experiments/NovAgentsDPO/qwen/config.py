...
# ============================================================
OUTPUT_BASE_DIR = "other_experiments/dpo_novagents/output1"

@dataclass
class Config:
    # --- Data paths ---
    # ROLLOUT INPUT: has 'input_text_without_lim' column — use this for generating rollouts
    ...
    # How many random rows to sample from rollout CSV
    ...
    # weak_model: str = "Qwen/Qwen2.5-3B-Instruct" 
