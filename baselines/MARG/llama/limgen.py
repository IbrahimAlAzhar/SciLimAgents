"""
MARG Pipeline — Llama 3 8B (Local HuggingFace)
Replaces AutoGen + GPT-4o-mini with direct HF pipeline calls.
...
OUTPUT_SLICE = "MARG/llama/df_marg_llama3_output.csv"
...
def call_agent(system_prompt: str) -> str:
    """
    Format a Llama-3-Instruct chat message and run inference.
