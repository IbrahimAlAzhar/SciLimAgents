"""
MARG Pipeline — Mistral 7B Instruct v0.3 (Local HuggingFace)
Replaces Llama 3 8B with Mistral-7B-Instruct-v0.3.
...
OUTPUT_SLICE = "MARG/mistral/df_marg_mistral7b_output.csv"
...
def call_agent(system_prompt: str) -> str:
    """
    Format a Mistral-Instruct chat message and run inference.
