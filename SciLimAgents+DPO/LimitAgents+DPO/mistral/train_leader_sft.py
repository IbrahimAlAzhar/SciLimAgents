"""
train_leader_sft.py — SFT (LoRA) training for the Leader agent.
...
Usage:
  python train_leader_sft.py \
      ...
      --data-path  data/.../sft_dataset_leader.json \
      --output-dir data/.../train/llama/leader_sft
"""
...
def parse_args():
    p = argparse.ArgumentParser(description="Leader SFT training.")
