"""
train_leader_sft.py — SFT training for the Leader agent (LoRA on Qwen 2.5 3B).

Can run in PARALLEL with train_worker_sft.py and train_master_sft.py.

Usage:
  python train_leader_sft.py
"""
...
SFT_DATA     = "other_experiments/dpo/sft_and_dpo_pairs/sft_dataset_leader.json"
OUTPUT_DIR   = "other_experiments/dpo/train/leader_sft"
...
def main():
    ...
    print(f"\nLeader SFT model saved to: {final_dir}")
    print("Done.")
