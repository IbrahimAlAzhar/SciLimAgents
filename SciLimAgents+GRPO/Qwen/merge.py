...
# ── Configuration ────────────────────────────────────────────────────
DF_LIM_PATH = "llm_agents/qwen_new/grpo_limagents/Qwen/inference/df_inference_grpo_worker_sft_leader_master_output.csv"
DF_NOV_PATH = "llm_agents/qwen_new/novagents/df_qwen_3b_novelty_agents_bal_data_output.csv"

# import pandas as pd 
# df_lim_dpo = pd.read_csv("llm_agents/qwen_new/grpo_limagents/Qwen/inference/df_inference_grpo_worker_sft_leader_master_output.csv") 
# df_nov = pd.read_csv("llm_agents/qwen_new/novagents/df_qwen_3b_novelty_agents_bal_data_output.csv") 

# Output Directory and Files
OUTPUT_DIR = "llm_agents/qwen_new/limagents_grpo+novagents"
...
def main():
    ...
    lim_skipped_mask = df_lim['final_limitations_master'].astype(str).str.contains("SKIPPED_SHORT_TEXT", na=False)
    ...
    for idx, row in df_lim_copy.iterrows():
        ...
        lim_master_text = row['final_limitations_master']
